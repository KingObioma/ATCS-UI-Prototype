...
export function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          'fixed top-0 left-0 z-50 h-full w-64 bg-white dark:bg-dark-surface border-r border-brand-muted/10 dark:border-brand-accent/20 transform transition-transform duration-300 ease-in-out lg:translate-x-0',
