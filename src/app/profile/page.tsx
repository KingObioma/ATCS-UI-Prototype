...
export default function ProfilePage() {
  ...
  // Using admin user data for demo
        ...
        <Card className="lg:col-span-1">
          <div className="text-center">
            ...
            <div className="relative inline-block">
              ...
              <button className="absolute bottom-0 right-0 w-10 h-10 bg-surface border-2 border-gray-200 rounded-full flex items-center justify-center shadow-sm hover:bg-gray-50 transition-colors">
            ...
            <div className="mt-6 space-y-3 text-left">
              ...
              <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                ...
                <span className="text-sm text-text-primary">ID: {user.id}</span>
              </div>
            </div>
          </div>
        </Card>
